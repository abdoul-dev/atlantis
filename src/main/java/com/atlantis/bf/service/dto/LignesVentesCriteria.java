...
/**
 * Criteria class for the {@link com.atlantis.bf.domain.LignesVentes} entity. This class is used
 * in {@link com.atlantis.bf.web.rest.LignesVentesResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /lignes-ventes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class LignesVentesCriteria implements Serializable, Criteria {
    ...
    public LignesVentesCriteria() {
    }

    public LignesVentesCriteria(LignesVentesCriteria other) {
    ...
    @Override
    public LignesVentesCriteria copy() {
        return new LignesVentesCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final LignesVentesCriteria that = (LignesVentesCriteria) o;
        return
