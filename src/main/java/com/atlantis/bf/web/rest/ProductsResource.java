...
/**
 * REST controller for managing {@link com.atlantis.bf.domain.Products}.
 */
@RestController
@RequestMapping("/api")
public class ProductsResource {
     ...
     */
    @GetMapping("/products")
    public ResponseEntity<List<ProductsDTO>> getAllProducts(ProductsCriteria criteria, Pageable pageable) {
