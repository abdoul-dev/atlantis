...
import { VentesComponent } from 'app/entities/ventes/ventes.component';
import { VentesService } from 'app/entities/ventes/ventes.service';
import { Ventes } from 'app/shared/model/ventes.model';

describe('Component Tests', () => {
  describe('Ventes Management Component', () => {
    let comp: VentesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VentesComponent, '')
        .compileComponents();
