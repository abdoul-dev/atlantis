...
import { TypeDepenseComponent } from 'app/entities/type-depense/type-depense.component';
...
describe('Component Tests', () => {
  describe('TypeDepense Management Component', () => {
    let comp: TypeDepenseComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TypeDepenseComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typeDepenses && comp.typeDepenses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
