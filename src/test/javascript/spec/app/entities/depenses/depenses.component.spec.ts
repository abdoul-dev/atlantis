...
import { DepensesComponent } from 'app/entities/depenses/depenses.component';
...
describe('Component Tests', () => {
  describe('Depenses Management Component', () => {
    let comp: DepensesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DepensesComponent, '')
        .compileComponents();
