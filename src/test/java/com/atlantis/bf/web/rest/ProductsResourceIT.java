...
public class ProductsResourceIT {
    ...
    public void createProducts() throws Exception {
        ...
        assertThat(testProducts.getQuantite()).isEqualTo(DEFAULT_QUANTITE);
    ...
    @Test
    @Transactional
    public void getAllProductsByQuantiteIsEqualToSomething() throws Exception {
        // Initialize the database
        productsRepository.saveAndFlush(products);

        // Get all the productsList where quantite equals to DEFAULT_QUANTITE
        defaultProductsShouldBeFound("quantite.equals=" + DEFAULT_QUANTITE);

        // Get all the productsList where quantite equals to UPDATED_QUANTITE
        defaultProductsShouldNotBeFound("quantite.equals=" + UPDATED_QUANTITE);
    }

    @Test
    @Transactional
    public void getAllProductsByQuantiteIsNotEqualToSomething() throws Exception {
        // Initialize the database
        productsRepository.saveAndFlush(products);

        // Get all the productsList where quantite not equals to DEFAULT_QUANTITE
        defaultProductsShouldNotBeFound("quantite.notEquals=" + DEFAULT_QUANTITE);

        // Get all the productsList where quantite not equals to UPDATED_QUANTITE
        defaultProductsShouldBeFound("quantite.notEquals=" + UPDATED_QUANTITE);
    }

    @Test
    @Transactional
    public void getAllProductsByQuantiteIsInShouldWork() throws Exception {
        // Initialize the database
        productsRepository.saveAndFlush(products);

        // Get all the productsList where quantite in DEFAULT_QUANTITE or UPDATED_QUANTITE
        defaultProductsShouldBeFound("quantite.in=" + DEFAULT_QUANTITE + "," + UPDATED_QUANTITE);

        // Get all the productsList where quantite equals to UPDATED_QUANTITE
        defaultProductsShouldNotBeFound("quantite.in=" + UPDATED_QUANTITE);
    }

    @Test
    @Transactional
    public void getAllProductsByQuantiteIsNullOrNotNull() throws Exception {
        // Initialize the database
        productsRepository.saveAndFlush(products);

        // Get all the productsList where quantite is not null
        defaultProductsShouldBeFound("quantite.specified=true");

        // Get all the productsList where quantite is null
        defaultProductsShouldNotBeFound("quantite.specified=false");
    }

    @Test
    @Transactional
    public void getAllProductsByQuantiteIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        productsRepository.saveAndFlush(products);

        // Get all the productsList where quantite is greater than or equal to DEFAULT_QUANTITE
        defaultProductsShouldBeFound("quantite.greaterThanOrEqual=" + DEFAULT_QUANTITE);

        // Get all the productsList where quantite is greater than or equal to UPDATED_QUANTITE
        defaultProductsShouldNotBeFound("quantite.greaterThanOrEqual=" + UPDATED_QUANTITE);
    }

    @Test
    @Transactional
    public void getAllProductsByQuantiteIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        productsRepository.saveAndFlush(products);

        // Get all the productsList where quantite is less than or equal to DEFAULT_QUANTITE
        defaultProductsShouldBeFound("quantite.lessThanOrEqual=" + DEFAULT_QUANTITE);

        // Get all the productsList where quantite is less than or equal to SMALLER_QUANTITE
        defaultProductsShouldNotBeFound("quantite.lessThanOrEqual=" + SMALLER_QUANTITE);
    }

    @Test
    @Transactional
    public void getAllProductsByQuantiteIsLessThanSomething() throws Exception {
        // Initialize the database
        productsRepository.saveAndFlush(products);

        // Get all the productsList where quantite is less than DEFAULT_QUANTITE
        defaultProductsShouldNotBeFound("quantite.lessThan=" + DEFAULT_QUANTITE);

        // Get all the productsList where quantite is less than UPDATED_QUANTITE
        defaultProductsShouldBeFound("quantite.lessThan=" + UPDATED_QUANTITE);
    }

    @Test
    @Transactional
    public void getAllProductsByQuantiteIsGreaterThanSomething() throws Exception {
        // Initialize the database
        productsRepository.saveAndFlush(products);

        // Get all the productsList where quantite is greater than DEFAULT_QUANTITE
        defaultProductsShouldNotBeFound("quantite.greaterThan=" + DEFAULT_QUANTITE);

        // Get all the productsList where quantite is greater than SMALLER_QUANTITE
        defaultProductsShouldBeFound("quantite.greaterThan=" + SMALLER_QUANTITE);
    }
    ...
    public void updateProducts() throws Exception {
        ...
        assertThat(testProducts.getQuantite()).isEqualTo(UPDATED_QUANTITE);
